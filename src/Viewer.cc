...
void Viewer::Run()
{
    ...
    pangolin::CreateWindowAndBind("YOLOv8-ORB-SLAM3: Map Viewer",1024,768);
    ...
    Ow.SetIdentity();
    cv::namedWindow("YOLOv8-ORB-SLAM3: Current Frame");
    ...
    while(1)
    {
        ...
        cv::imshow("YOLOv8-ORB-SLAM3: Current Frame",toShow);
        cv::waitKey(mT);
